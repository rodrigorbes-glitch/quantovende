      ...
      <header className="border-b border-border/40 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => { window.location.href = '/'; }}>
            ...
            <span className="font-bold text-xl tracking-tight">Quanto<span className="text-primary">Vende</span></span>
          </div>
          <div>
            <button 
              onClick={() => {
              ...
              className="text-xs font-medium text-foreground/50 hover:text-foreground transition-colors px-3 py-1.5 border border-border/40 rounded-lg bg-background shadow-sm hover:shadow"
            >
              Limpar dados
            </button>
          </div>
